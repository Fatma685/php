...
<body>
  ...
  //Récupérer les données du formulaire et alimenter le tableau 
  ...
  //il faut créer deux tableaux pour modéliser la structure du tableau 
  $heures = ['08-09', '09-10', '10-11', '11-12', '12-13', '13-14', '14-15', '15-16', '1617'];
  $jours = ['lundi', 'mardi', 'mercredi', 'jeudi', 'vendredi', 'samedi'];
  ?>
